package iteratorEstatico;

import java.util.Iterator;

public class ListaEstatica<ClasseParametrizada> implements Iterable<ClasseParametrizada> {
    ...
    @Override
    public Iterator<ClasseParametrizada> iterator() {
       return new IteradorListaDupla();
    }

    private class IteradorListaDupla implements Iterator<ClasseParametrizada> {
       ...
       @Override
       public ClasseParametrizada next() {
    	   return info[index++];
       }
    }
}
